...
**YOU ARE IN: `beads/polecats/garnet/`** — This is YOUR worktree. Stay here.
...
```bash
pwd  # Should show .../polecats/garnet
```
...
**Your mail address:** `beads/polecats/garnet`
**Your rig:** beads
...
1. Announce: "Polecat garnet, checking in."
2. Run: `gt prime`
